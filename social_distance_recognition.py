# -*- coding: utf-8 -*-
"""
Created on Thu May 22 23:41:01 2020

@author: Arpita Kumari

SOCIAL DISTANCE DETECTOR USING OPENCV AND YOLOv3
"""
...
net = cv2.dnn.readNet("F:/projects/objectdetection/YOLO FILES/yolov3.weights",
                      "F:/projects/objectdetection/YOLO FILES/yolov3.cfg")
with open("F:/projects/objectdetection/model/coco_classes.txt","r") as f:
...
videoloc = "F:/projects/Social-Distance-Recognition-using-OpenCV-and-Python-master/social_distance_video_1.mp4"
...
while True:
    ...
    if len(indexes)>0:
        ...
        for i in idf:
            ...
            high_str = "PEOPLE WITH HIGH RISK: " + str(high_risk_p)
            low_str = "PEOPLE WITH MEDIUM RISK: " + str(low_risk_p)
            safe_str = "SAFE PEOPLE: " + str(safe_p)
            
            cv2.putText(frame, "INFO PER FRAME : ", (10, 25),font, 1, (0, 0, 0), 4)            
            cv2.putText(frame, tot_str, (10, 60),font, 1, (255, 255, 255), 4)
            cv2.putText(frame, safe_str, (10, 95),font, 1, (0, 255, 0), 4)
            cv2.putText(frame, low_str, (10, 130),font, 1, (0, 120, 255), 4)
            cv2.putText(frame, high_str, (10, 165),font, 1, (0, 0, 255), 4)
